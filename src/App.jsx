      ...
      {expanded && (
        <div style={{ padding:"0 24px 24px", borderTop:"1px solid rgba(255,255,255,0.06)", paddingTop:20 }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, marginBottom:20 }}>
            {{soundLink && <Box label="Sound Link">{soundThumb && <img src={soundThumb} style={{ width:60, height:60, borderRadius:8, objectFit:"cover", marginBottom:8, display:"block" }} />}<a href={soundLink} target="_blank" rel="noreferrer" style={{ color:"#FF6B00", textDecoration:"none", wordBreak:"break-all" }}>{soundLink}</a></Box>}
